...
function initJsSweetness() {
	if (blockrc == 'true') {
		$j(this).bind("conte  xtmenu", function(e) {
			e.preventDefault();
		});
	}
...
/*
     ...
     INTERNET ARCHIVE ON 07:54:44 Sep 23, 2024.
...
playback timings (ms):
  ...
  esindex: 0.026
  cdx.remote: 7.845
  LoadShardBlock: 107.903 (3)
  PetaboxLoader3.datanode: 50.435 (4)
  PetaboxLoader3.resolve: 170.996 (2)
  load_resource: 162.357
*/